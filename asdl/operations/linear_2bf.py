...
import os
assert os.environ.get('accutype') == "bf"
...
class Linear(Operation):
    ...
    def cov_kron_A(module, in_data):
        return torch.matmul(in_data.bfloat16().T, in_data.bfloat16())  # f_in x f_in
    ...
    def cov_kron_B(module, out_grads):
        return torch.matmul(out_grads.bfloat16().T, out_grads.bfloat16())  # f_out x f_out
